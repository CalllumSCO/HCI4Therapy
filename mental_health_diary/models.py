...
class Entry(models.Model):
    ...
    best_moment = models.TextField(max_length=500)
    share_best = models.TextField(max_length=500)
    worst_moment = models.TextField(max_length=500)
    deal_worst = models.TextField(max_length=500)
    coping_mech = models.TextField(max_length=500)
    anything_different = models.TextField(max_length=500)
    smile = models.TextField(max_length=500)
    url = models.CharField(null=True, max_length=10)
    class Meta:
