...
class Entry(models.Model):
    ...
    best_moment = models.TextField(max_length=500, null=True)
    share_best = models.TextField(max_length=500, null=True)
    worst_moment = models.TextField(max_length=500, null=True)
    deal_worst = models.TextField(max_length=500, null=True)
    coping_mech = models.TextField(max_length=500, null=True)
    anything_different = models.TextField(max_length=500, null=True)
    smile = models.TextField(max_length=500, null=True)
    url = models.CharField(null=True, max_length=10)
    class Meta:
